...
declare -A REMOTE_BASE=([master]="github.com/vfhqi/master.git" [ratings]="github.com/vfhqi/ratings.git" [landing]="github.com/vfhqi/landing.git")
declare -A COWORK_REPO_DIR=([master]="master-dashboard" [ratings]="databases" [landing]=".")
